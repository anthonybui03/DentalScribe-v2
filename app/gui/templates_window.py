"""Manage custom note templates — v2 CustomTkinter."""
import customtkinter as ctk
from app.gui.theme import C, make_font, primary_btn, ghost_btn, make_entry, make_textbox
from app.models.note_templates import TEMPLATES, save_custom_template, delete_custom_template


class TemplatesWindow(ctk.CTkToplevel):

    def __init__(self, parent, cfg: dict = None, on_change=None, on_close=None):
        super().__init__(parent)
        self.cfg = cfg
        self.on_change = on_change or on_close
        self.title("Manage Templates — DentalScribe v2")
    ...
    def _build_ui(self) -> None:
        ...
        ghost_btn(left, "+ New Template", command=self._new_template,
                  height=32).grid(row=2, column=0, sticky="ew",
                                   padx=8, pady=(0, 10))
        ...
        self._name_entry = make_entry(right, textvariable=self._name_var,
                                      placeholder="Template name", width=340)
        ...
        self._delete_btn = ghost_btn(btn_bar, "Delete", command=self._delete,
    ...
    def _refresh_list(self) -> None:
        ...
        for name, data in TEMPLATES.items():
            ...
            btn = ctk.CTkButton(self._list_frame, text=lbl, anchor="w",
                                ...
                                text_color=C["text2"],
                                font=make_font(11), height=32, corner_radius=6,
    ...
    def _delete(self) -> None:
        if not self._selected:
            return
        delete_custom_template(self._selected)
        self._selected = None
        self._name_var.set("")
        self._body.configure(state="normal")
        self._body.delete("1.0", "end")
